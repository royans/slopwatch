...
from slopguard.core.dto import SquatDetection, Ecosystem, ThreatVerdict, format_iso_seconds
from slopguard.core.signals import catalog_as_rows, findings_from_analysis_details
from slopguard.core.taxonomies import VENDOR_DOMAINS, PUBLIC_EMAIL_PROVIDERS, DISPOSABLE_EMAIL_DOMAINS
...
class DossierExporter:
    ...
    async def export_all(self, limit: int = 50000) -> Dict[str, Any]:
        ...
        for d in detections:
            ...
            from slopguard.assessor.scorer import has_install_time_code_execution, has_install_time_network_socket
