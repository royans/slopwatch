...
logger = logging.getLogger("slopguard.repository")
...
from slopguard.db.models import (
...
from slopguard.core.signals import findings_from_analysis_details, severity_rank
...
class SlopGuardRepository:
    ...
    async def mark_grammar_matching_packages(
        ...
        entity+capability+framework naming grammar (slopguard.matrix.generator), using
