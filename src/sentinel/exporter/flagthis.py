"""
FlagThis Sentinel FlagThis.com Web Search & Threat Intelligence Exporter.
...
class FlagThisExporter:
    def __init__(self, repository: SentinelRepository, output_dir: Path = Path("reports/flagthis_export")):
    ...
    async def export_all(self, limit: int = 50000) -> Dict[str, Any]:
        ...
        for d in detections:
            ...
            # active security threat signal for FlagThis.com's public threat feed — skip
        ...
        # (336MB x2), presumably for backward compat with whichever name FlagThis.com's
        ...
        # Write to search/ for FlagThis instant client lookup
...
* 🛡️ **FlagThis Search & Dossier**: [View on FlagThis.com](/slopsquat/{detection.ecosystem.value}/{detection.package_name})
...
---
*Report automatically generated by FlagThis Sentinel (Project SpectreCatch).*
"""
