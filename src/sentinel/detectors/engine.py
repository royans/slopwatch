...
(``sentinel.assessor.scorer``) still owns the verdict ladder and the authoritative
...
from sentinel.detectors.base import Detector, PackageContext, load_all_detectors

logger = logging.getLogger("sentinel.detectors.engine")
