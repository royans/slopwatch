...
VENDOR_DOMAINS: Dict[str, List[str]] = {
    ...
    "coinbase-base": ["base.org", "coinbase.com"],
    "base-org": ["base.org", "coinbase.com"],
    "ripple": ["ripple.com"],
    "xrp": ["ripple.com"],
    "tron": ["tron.network"],
    ...
    # Security & Enterprise Vendors (realistic typosquat/impersonation targets —
    # e.g. the real-world "SentinelOne" PyPI malware sample impersonated this
    # exact brand and would otherwise get zero naming-heuristic credit)
    ...
    "sophos": ["sophos.com"],
    "mcafee": ["mcafee.com"],
    "symantec": ["broadcom.com", "symantec.com"],
    "rapid7": ["rapid7.com"],
    "tenable": ["tenable.com"],
    "qualys": ["qualys.com"],
    "snyk": ["snyk.io"],
    ...
    "twilio": ["twilio.com"],
    "segment": ["segment.com", "twilio.com"],
    ...
    "duo": ["duo.com", "duosecurity.com", "cisco.com"],
    "wiz": ["wiz.io"],
