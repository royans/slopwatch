...
(``slopwatch.assessor.scorer``) still owns the verdict ladder and the authoritative
...
from slopwatch.detectors.base import Detector, PackageContext, load_all_detectors

logger = logging.getLogger("slopwatch.detectors.engine")
